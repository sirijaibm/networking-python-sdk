...
"""
Integration test code to execute Zones Settings V1
"""
...
class TestZonesSettingsV1(unittest.TestCase):
    ...
    def test_2_update_zone_dnssec(self):
        ...
        response = self.service.update_zone_dnssec(status='active')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_4_update_zone_cname_flattening(self):
        ...
        response = self.service.update_zone_cname_flattening(value='flatten_at_root')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_6_update_opportunistic_encryption(self):
        ...
        response = self.service.update_opportunistic_encryption(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_8_update_opportunistic_onion(self):
        ...
        response = self.service.update_opportunistic_onion(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_10_update_challenge_ttl(self):
        ...
        response = self.service.update_challenge_ttl(value=1800)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_12_update_automatic_https_rewrites(self):
        ...
        response = self.service.update_automatic_https_rewrites(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_14_update_true_client_ip(self):
        ...
        response = self.service.update_true_client_ip(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_16_update_always_use_https(self):
        ...
        response = self.service.update_always_use_https(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_18_update_image_size_optimization(self):
        ...
        response = self.service.update_image_size_optimization(value='lossless')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_20_update_script_load_optimization(self):
        ...
        response = self.service.update_script_load_optimization(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_22_update_image_load_optimization(self):
        ...
        response = self.service.update_image_load_optimization(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_24_update_minify(self):
        """ test update minify """
        from ibm_cloud_networking_services.zones_settings_v1 import MinifySettingValue
        minify_value = MinifySettingValue(css='on', html='on', js='on')
        response = self.service.update_minify(value=minify_value)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_26_update_min_tls_version(self):
        ...
        response = self.service.update_min_tls_version(value='1.2')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_28_update_ip_geolocation(self):
        ...
        response = self.service.update_ip_geolocation(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_30_update_server_side_exclude(self):
        ...
        response = self.service.update_server_side_exclude(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_32_update_security_header(self):
        ...
        from ibm_cloud_networking_services.zones_settings_v1 import SecurityHeaderSettingValue
        security_header_value = SecurityHeaderSettingValue(
            strict_transport_security={'enabled': True, 'max_age': 86400, 'include_subdomains': True, 'nosniff': True}
        )
        response = self.service.update_security_header(value=security_header_value)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_34_update_mobile_redirect(self):
        ...
        from ibm_cloud_networking_services.zones_settings_v1 import MobileRedirecSettingValue
        mobile_redirect_value = MobileRedirecSettingValue(
            status='on',
            mobile_subdomain='m',
            strip_uri=False
        )
        response = self.service.update_mobile_redirect(value=mobile_redirect_value)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_36_update_prefetch_preload(self):
        ...
        response = self.service.update_prefetch_preload(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_38_update_http2(self):
        """ test update http2 """
        response = self.service.update_http2(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_40_update_http3(self):
        """ test update http3 """
        response = self.service.update_http3(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_42_update_ipv6(self):
        """ test update ipv6 """
        response = self.service.update_ipv6(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_44_update_web_sockets(self):
        ...
        response = self.service.update_web_sockets(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_46_update_pseudo_ipv4(self):
        ...
        response = self.service.update_pseudo_ipv4(value='add_header')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_48_update_response_buffering(self):
        ...
        response = self.service.update_response_buffering(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_50_update_hotlink_protection(self):
        ...
        response = self.service.update_hotlink_protection(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_52_update_max_upload(self):
        ...
        response = self.service.update_max_upload(value=100)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_54_update_tls_client_auth(self):
        ...
        response = self.service.update_tls_client_auth(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_56_update_brotli(self):
        """ test update brotli """
        response = self.service.update_brotli(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_58_update_proxy_read_timeout(self):
        ...
        response = self.service.update_proxy_read_timeout(value=100)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_60_update_browser_check(self):
        ...
        response = self.service.update_browser_check(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_62_update_enable_error_pages_on(self):
        ...
        response = self.service.update_enable_error_pages_on(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_64_update_web_application_firewall(self):
        ...
        response = self.service.update_web_application_firewall(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_66_update_ciphers(self):
        """ test update ciphers """
        response = self.service.update_ciphers(value=['ECDHE-RSA-AES128-GCM-SHA256'])
        assert response is not None
        assert response.status_code == 200
    ...
    def test_68_update_origin_max_http_version(self):
        ...
        response = self.service.update_origin_max_http_version(value='2')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_70_update_origin_post_quantum_encryption(self):
        ...
        response = self.service.update_origin_post_quantum_encryption(value='preferred')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_71_get_log_retention(self):
        ...
        response = self.service.get_log_retention(crn=self.crn, zone_identifier=self.zone_id)
        assert response is not None
        assert response.status_code == 200

    def test_72_update_log_retention(self):
        """ test update log retention """
        response = self.service.update_log_retention(crn=self.crn, zone_identifier=self.zone_id, flag=True)
        assert response is not None
        assert response.status_code == 200
    ...
    def test_76_update_replace_insecure_js(self):
        ...
        response = self.service.update_replace_insecure_js(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_78_update_email_obfuscation(self):
        ...
        response = self.service.update_email_obfuscation(value='on')
        assert response is not None
        assert response.status_code == 200
    ...
    def test_80_update_security_level(self):
        ...
        response = self.service.update_security_level(value='medium')
        assert response is not None
        assert response.status_code == 200
