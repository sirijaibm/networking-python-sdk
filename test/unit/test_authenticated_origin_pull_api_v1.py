...
class TestListAllPerHostnameAuthenticatedOriginPullSettings:
    """
    Test Class for list_all_per_hostname_authenticated_origin_pull_settings
    """

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_settings_all_params(self):
        """
        list_all_per_hostname_authenticated_origin_pull_settings()
        """
        # Set up mock
        ...
        # Invoke method
        response = _service.list_all_per_hostname_authenticated_origin_pull_settings(
            x_correlation_id=x_correlation_id,
            headers={},
        )
    ...
    def test_list_all_per_hostname_authenticated_origin_pull_settings_all_params_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_all_params.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_all_params()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_all_params.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_all_params()

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_settings_required_params(self):
        """
        test_list_all_per_hostname_authenticated_origin_pull_settings_required_params()
        """
        # Set up mock
        url = preprocess_url('/v1/testString/zones/testString/origin_tls_client_auth/hostnames')
        mock_response = '{"result": [{"hostname": "app.example.com", "cert_id": "2458ce5a-0c35-4c7f-82c7-8e9487d3ff60", "enabled": true, "status": "active", "created_at": "2100-01-01T05:20:00.000Z", "updated_at": "2100-01-01T05:20:00.000Z", "cert_status": "active", "issuer": "GlobalSign", "signature": "SHA256WithRSA", "serial_number": "6743787633689793699141714808227354901", "certificate": "-----BEGIN CERTIFICATE-----\n......\n-----END CERTIFICATE-----\n", "cert_uploaded_on": "2019-10-28T18:11:23.374Z", "cert_updated_at": "2100-01-01T05:20:00.000Z", "expires_on": "2100-01-01T05:20:00.000Z"}], "success": true, "errors": ["errors"], "messages": ["messages"]}'
    ...
    def test_list_all_per_hostname_authenticated_origin_pull_settings_required_params_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_required_params.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_required_params()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_required_params.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_required_params()

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_settings_value_error(self):
        """
        test_list_all_per_hostname_authenticated_origin_pull_settings_value_error()
        """
        # Set up mock
        url = preprocess_url('/v1/testString/zones/testString/origin_tls_client_auth/hostnames')
        mock_response = '{"result": [{"hostname": "app.example.com", "cert_id": "2458ce5a-0c35-4c7f-82c7-8e9487d3ff60", "enabled": true, "status": "active", "created_at": "2100-01-01T05:20:00.000Z", "updated_at": "2100-01-01T05:20:00.000Z", "cert_status": "active", "issuer": "GlobalSign", "signature": "SHA256WithRSA", "serial_number": "6743787633689793699141714808227354901", "certificate": "-----BEGIN CERTIFICATE-----\n......\n-----END CERTIFICATE-----\n", "cert_uploaded_on": "2019-10-28T18:11:23.374Z", "cert_updated_at": "2100-01-01T05:20:00.000Z", "expires_on": "2100-01-01T05:20:00.000Z"}], "success": true, "errors": ["errors"], "messages": ["messages"]}'
        ...
        for param in req_param_dict.keys():
            req_copy = {key: val if key is not param else None for (key, val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.list_all_per_hostname_authenticated_origin_pull_settings(**req_copy)

    def test_list_all_per_hostname_authenticated_origin_pull_settings_value_error_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_value_error.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_value_error()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_settings_value_error.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_settings_value_error()
...
class TestListAllPerHostnameAuthenticatedOriginPullCertificates:
    """
    Test Class for list_all_per_hostname_authenticated_origin_pull_certificates
    """

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params(self):
        """
        list_all_per_hostname_authenticated_origin_pull_certificates()
        """
        # Set up mock
        ...
        # Invoke method
        response = _service.list_all_per_hostname_authenticated_origin_pull_certificates(
            x_correlation_id=x_correlation_id,
            headers={},
        )
    ...
    def test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_all_params()

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params(self):
        """
        test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params()
        """
        # Set up mock
        url = preprocess_url('/v1/testString/zones/testString/origin_tls_client_auth/hostnames/certificates')
        mock_response = '{"result": [{"id": "0f405ba2-8c18-49eb-a30b-28b85427780f", "certificate": "-----BEGIN CERTIFICATE-----\n......\n-----END CERTIFICATE-----\n", "issuer": "GlobalSign", "signature": "SHA256WithRSA", "serial_number": "6743787633689793699141714808227354901", "status": "active", "expires_on": "2100-01-01T05:20:00Z", "uploaded_on": "2100-01-01T05:20:00Z"}], "success": true, "errors": ["errors"], "messages": ["messages"]}'
    ...
    def test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_required_params()

    @responses.activate
    def test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error(self):
        """
        test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error()
        """
        # Set up mock
        url = preprocess_url('/v1/testString/zones/testString/origin_tls_client_auth/hostnames/certificates')
        mock_response = '{"result": [{"id": "0f405ba2-8c18-49eb-a30b-28b85427780f", "certificate": "-----BEGIN CERTIFICATE-----\n......\n-----END CERTIFICATE-----\n", "issuer": "GlobalSign", "signature": "SHA256WithRSA", "serial_number": "6743787633689793699141714808227354901", "status": "active", "expires_on": "2100-01-01T05:20:00Z", "uploaded_on": "2100-01-01T05:20:00Z"}], "success": true, "errors": ["errors"], "messages": ["messages"]}'
        ...
        for param in req_param_dict.keys():
            req_copy = {key: val if key is not param else None for (key, val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.list_all_per_hostname_authenticated_origin_pull_certificates(**req_copy)

    def test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error_with_retries(self):
        # Enable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error.
        _service.enable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error()

        # Disable retries and run test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error.
        _service.disable_retries()
        self.test_list_all_per_hostname_authenticated_origin_pull_certificates_value_error()
...
class TestModel_ListHostnameOriginPullCertificatesResp:
    """
    Test Class for ListHostnameOriginPullCertificatesResp
    """

    def test_list_hostname_origin_pull_certificates_resp_serialization(self):
        """
        Test serialization/deserialization for ListHostnameOriginPullCertificatesResp
        """
        ...
        # Construct a json representation of a ListHostnameOriginPullCertificatesResp model
        list_hostname_origin_pull_certificates_resp_model_json = {}
        list_hostname_origin_pull_certificates_resp_model_json['result'] = [hostname_certificate_pack_model]
        list_hostname_origin_pull_certificates_resp_model_json['success'] = True
        list_hostname_origin_pull_certificates_resp_model_json['errors'] = ['testString']
        list_hostname_origin_pull_certificates_resp_model_json['messages'] = ['testString']

        # Construct a model instance of ListHostnameOriginPullCertificatesResp by calling from_dict on the json representation
        list_hostname_origin_pull_certificates_resp_model = ListHostnameOriginPullCertificatesResp.from_dict(list_hostname_origin_pull_certificates_resp_model_json)
        assert list_hostname_origin_pull_certificates_resp_model != False

        # Construct a model instance of ListHostnameOriginPullCertificatesResp by calling from_dict on the json representation
        list_hostname_origin_pull_certificates_resp_model_dict = ListHostnameOriginPullCertificatesResp.from_dict(list_hostname_origin_pull_certificates_resp_model_json).__dict__
        list_hostname_origin_pull_certificates_resp_model2 = ListHostnameOriginPullCertificatesResp(**list_hostname_origin_pull_certificates_resp_model_dict)

        # Verify the model instances are equivalent
        assert list_hostname_origin_pull_certificates_resp_model == list_hostname_origin_pull_certificates_resp_model2

        # Convert model instance back to dict and verify no loss of data
        list_hostname_origin_pull_certificates_resp_model_json2 = list_hostname_origin_pull_certificates_resp_model.to_dict()
        assert list_hostname_origin_pull_certificates_resp_model_json2 == list_hostname_origin_pull_certificates_resp_model_json
