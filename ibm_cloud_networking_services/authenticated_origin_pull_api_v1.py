...
class AuthenticatedOriginPullApiV1(BaseService):
    ...
    def get_zone_origin_pull_settings(
        self,
        *,
    ...
    def set_zone_origin_pull_settings(
        self,
        *,
    ...
    def list_zone_origin_pull_certificates(
        self,
        *,
        x_correlation_id: Optional[str] = None,
        **kwargs,
    ...
    def upload_zone_origin_pull_certificate(
        self,
        *,
    ...
    def get_zone_origin_pull_certificate(
        self,
        cert_identifier: str,
        *,
        x_correlation_id: Optional[str] = None,
    ...
    def delete_zone_origin_pull_certificate(
        self,
        cert_identifier: str,
        *,
        x_correlation_id: Optional[str] = None,
    ...
    def list_all_per_hostname_authenticated_origin_pull_settings(
        self,
        *,
        x_correlation_id: Optional[str] = None,
        **kwargs,
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='list_all_per_hostname_authenticated_origin_pull_settings',
        )
        headers.update(sdk_headers)
    ...
    def set_hostname_origin_pull_settings(
        self,
        *,
        config: Optional[List['HostnameOriginPullSettings']] = None,
        x_correlation_id: Optional[str] = None,
        **kwargs,
    ) -> DetailedResponse:
        """
    ...
    def get_hostname_origin_pull_settings(
        self,
        hostname: str,
        *,
        x_correlation_id: Optional[str] = None,
    ...
    def list_all_per_hostname_authenticated_origin_pull_certificates(
        self,
        *,
        x_correlation_id: Optional[str] = None,
        **kwargs,
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ListHostnameOriginPullCertificatesResp` object
        """
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='list_all_per_hostname_authenticated_origin_pull_certificates',
        )
        headers.update(sdk_headers)
    ...
    def upload_hostname_origin_pull_certificate(
        self,
        *,
        certificate: Optional[str] = None,
        private_key: Optional[str] = None,
    ...
    def get_hostname_origin_pull_certificate(
        self,
        cert_identifier: str,
        *,
        x_correlation_id: Optional[str] = None,
    ...
    def delete_hostname_origin_pull_certificate(
        self,
        cert_identifier: str,
        *,
        x_correlation_id: Optional[str] = None,
...
class CertificatePack:
    ...
    def from_dict(cls, _dict: Dict) -> 'CertificatePack':
        ...
        if (uploaded_on := _dict.get('uploaded_on')) is not None:
            args['uploaded_on'] = uploaded_on
        return cls(**args)
...
class GetHostnameOriginPullSettingsResp:
    ...
    def __init__(
        self,
        *,
        result: Optional['HostnameSettingsResp'] = None,
    ...
    def from_dict(cls, _dict: Dict) -> 'GetHostnameOriginPullSettingsResp':
        ...
        if (result := _dict.get('result')) is not None:
            args['result'] = HostnameSettingsResp.from_dict(result)
...
class GetZoneOriginPullSettingsResp:
    ...
    def __init__(
        self,
        *,
        result: Optional['GetZoneOriginPullSettingsRespResult'] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
    ...
    def from_dict(cls, _dict: Dict) -> 'GetZoneOriginPullSettingsResp':
        ...
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = GetZoneOriginPullSettingsRespResult.from_dict(result)
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
...
class HostnameOriginPullCertificateResp:
    ...
    def __init__(
        self,
        *,
        result: Optional['HostnameCertificatePack'] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
    ...
    def from_dict(cls, _dict: Dict) -> 'HostnameOriginPullCertificateResp':
        ...
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = HostnameCertificatePack.from_dict(result)
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
...
class HostnameOriginPullSettings:
    ...
    :param str hostname: the hostname on the origin for which the client certificate
    ...
    def from_dict(cls, _dict: Dict) -> 'HostnameOriginPullSettings':
        ...
        if (cert_id := _dict.get('cert_id')) is not None:
...
class HostnameSettingsResp:
    ...
    :param str hostname: (optional) the hostname on the origin for which the client
          certificate uploaded will be used.
    ...
    :param datetime updated_at: (optional) the time when the certificate was
          updated.
    :param str cert_status: (optional) status of the certificate or the association.
    :param str issuer: (optional) the certificate authority that issued the
          certificate.
    :param str signature: (optional) the type of hash used for the certificate.
    :param str serial_number: (optional) the serial number on the uploaded
    ...
    :param datetime cert_uploaded_on: (optional) the time the certificate was
          uploaded.
    :param datetime cert_updated_at: (optional) the time when the certificate was
          updated.
    :param datetime expires_on: (optional) the date when the certificate expires.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'HostnameSettingsResp':
        ...
        if (cert_status := _dict.get('cert_status')) is not None:
            args['cert_status'] = cert_status
        if (issuer := _dict.get('issuer')) is not None:
            args['issuer'] = issuer
        if (signature := _dict.get('signature')) is not None:
            args['signature'] = signature
        ...
        if (certificate := _dict.get('certificate')) is not None:
            args['certificate'] = certificate
        if (cert_uploaded_on := _dict.get('cert_uploaded_on')) is not None:
            args['cert_uploaded_on'] = string_to_datetime(cert_uploaded_on)
        if (cert_updated_at := _dict.get('cert_updated_at')) is not None:
            args['cert_updated_at'] = string_to_datetime(cert_updated_at)
        if (expires_on := _dict.get('expires_on')) is not None:
...
class ListHostnameOriginPullCertificatesResp:
    """
    array of hostname level authenticated origin pull settings response.

    :param List[HostnameCertificatePack] result: (optional) array of hostname
    ...
    def __init__(
        self,
        *,
        result: Optional[List['HostnameCertificatePack']] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
        """
        Initialize a ListHostnameOriginPullCertificatesResp object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ListHostnameOriginPullCertificatesResp':
        """Initialize a ListHostnameOriginPullCertificatesResp object from a json dictionary."""
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = [HostnameCertificatePack.from_dict(v) for v in result]
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ListHostnameOriginPullCertificatesResp object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ListHostnameOriginPullCertificatesResp') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ListHostnameOriginPullCertificatesResp') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ListHostnameOriginPullSettingsResp:
    ...
    :param List[HostnameSettingsResp] result: (optional) array of hostname settings
          response.
    :param bool success: (optional) success.
    :param List[str] errors: (optional)
    :param List[str] messages: (optional)
    ...
    def __init__(
        self,
        *,
        result: Optional[List['HostnameSettingsResp']] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
    ...
    def from_dict(cls, _dict: Dict) -> 'ListHostnameOriginPullSettingsResp':
        ...
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = [HostnameSettingsResp.from_dict(v) for v in result]
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
...
class ListZoneOriginPullCertificatesResp:
    ...
    def __init__(
        self,
        *,
        result: Optional[List['CertificatePack']] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
    ...
    def from_dict(cls, _dict: Dict) -> 'ListZoneOriginPullCertificatesResp':
        ...
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = [CertificatePack.from_dict(v) for v in result]
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
...
class ZoneOriginPullCertificateResp:
    ...
    def __init__(
        self,
        *,
        result: Optional['CertificatePack'] = None,
        success: Optional[bool] = None,
        errors: Optional[List[str]] = None,
        messages: Optional[List[str]] = None,
    ) -> None:
    ...
    def from_dict(cls, _dict: Dict) -> 'ZoneOriginPullCertificateResp':
        ...
        args = {}
        if (result := _dict.get('result')) is not None:
            args['result'] = CertificatePack.from_dict(result)
        if (success := _dict.get('success')) is not None:
            args['success'] = success
        if (errors := _dict.get('errors')) is not None:
            args['errors'] = errors
